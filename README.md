...
![Tests](https://img.shields.io/badge/tests-548%20passing-green)
...
1. Prefer `codex exec resume --last` (cwd-aware and safer against stale thread ids)
2. Fall back to stored thread id from `.ralph/.codex_session_id`
